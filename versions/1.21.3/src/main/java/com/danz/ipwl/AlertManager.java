        ...
        MutableText accept = Text.literal(IPWLMessages.get("ipwl.alert.btn_accept"))
            .styled(style -> style
                ...
                .withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT,
                    Text.literal(IPWLMessages.fmt("ipwl.alert.hover_accept", username, ip)))));

        String banCmd = IPWLMessages.fmt("ipwl.alert.cmd_ban", ip);
        MutableText ban = Text.literal(IPWLMessages.get("ipwl.alert.btn_ban"))
            .styled(style -> style
                .withClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, banCmd))
                .withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT,
                    Text.literal(IPWLMessages.fmt("ipwl.alert.hover_ban", ip)))));
